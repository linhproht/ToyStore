			...
			
		{
			if ($pic['size'] <= 614400) {
				...
				if (mysqli_num_rows($result) == 0) {
					...
					mysqli_query($conn, $sqstring);
					echo '<meta http-equiv="refresh" content="0;URL=index.php?page=product_management"/>';				

				} 
				else 
				{
					echo "<li>Duplicate product ID or Name";
				}
			}
			else 
			{
				echo "Size of image too biggggggggggggggggggggggggggggggggggg";
			}
		} 
		else 
		{
...
?>
<div class="container">
	<h2 style="text-align: center;">Adding new Product</h2>
