...
?>
    ...
    <script language = "javascript">
        ...
        {
            if(confirm("Are you sure about deleting product"))
            {
                return true;
        ...
        <p>
            ...
            <a href="index.php?page=add_product">Add new</a>
        </p>
        <table id="tableproduct" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<tr>
             ...
             <td align='center' class='cotNutChucNang'><a href="index.php?page=update_product&&id=<?php echo $row["Product_ID"]; ?>">
             <img src='images/edit.png' border='0'/></a></td>
             <td align='center' class='cotNutChucNang'><a href="?page=product_management&&function=del&&id=<?php echo $row["Product_ID"]; ?>"
