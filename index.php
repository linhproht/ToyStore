...
<!--datatable-->
  ...
  ?>
<div class="js--handle-header-transparency _position-special">
   ...
   <header id="header"><!--header-->
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 833 102 718</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> dlilcc718@gmail.com</a></li>
							</ul>
						</div>
					</div>
		...
		<div class="header-middle" style="background-color:#2D3544"><!--header-middle-->
			<div class="container" >
				<div>
					<div class="col-sm-6" >
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav" style="margin: 15px;" >
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                    <li><a style="background-color: #2D3544;color:#FFF" href="?page=update_customer">
                                    <i class="fa fa-lock"></i>Welcome, <?php echo $_SESSION['us']?></a>
                                    </li>
                                    <li><a href="?page=logout" style="background-color:#2D3544;color:#FFF">
                                ...
                                <li><a href="?page=login" style="background-color:#2D3544;color:#FFF">
                                <i class="fa fa-lock"></i>Login</a></li>
                                <li><a href="?page=register" style="background-color:#2D3544;color:#FFF">
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left ">                         
							<ul class="nav navbar-nav collapse navbar-collapse" >
								<li><a tabindex="5" href="index.php" class="active">Home</a></li>								
    ...
    <div class="footer-top-area" style="background-color: #2D3544;">
